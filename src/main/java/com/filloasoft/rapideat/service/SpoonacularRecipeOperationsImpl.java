...
@Service
public class SpoonacularRecipeOperationsImpl implements SpoonacularRecipeOperations {
    ...
    public SpoonacularRecipe getRecipe(String recipeID) throws IOException {
        ...
        List<OpenfoodProduct> listIngredients = new ArrayList<OpenfoodProduct>();
        for (int i = 0; i < arr1.size(); i++) {
            OpenfoodProduct p = new OpenfoodProduct();
    ...
    public List<SpoonacularRecipe> getRecipesByIngredients(String ingredientsKeywords, int numResults) throws IOException {
        ...
        List<SpoonacularRecipe> listRecipe = new ArrayList<SpoonacularRecipe>();
    ...
    public List<SpoonacularRecipe> FullRecipesSearch(String query, String cuisine, String includeIngredients,
